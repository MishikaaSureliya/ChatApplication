...
{
    /// <inheritdoc />
    public partial class AddCallFields_v2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GroupMem__3214EC07E69A1856", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Groups__149AF36A1DE14CB3", x => x.GroupId);
                });
